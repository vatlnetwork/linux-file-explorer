...
class _PreviewOptionsDialogState extends State<PreviewOptionsDialog> {
  ...
  Widget build(BuildContext context) {
    final isImage = [
      ...
      '.bmp',
      '.webp',
    ].contains(widget.fileItem.fileExtension.toLowerCase());
        ...
        child: Column(
          ...
          children: [
            ...
            _buildSwitchTile(
              ...
              (value) => setState(
                () =>
                    _currentOptions = _currentOptions.copyWith(showTags: value),
              ),
            ),
            _buildSwitchTile(
              'Created Date',
            ...
            _buildSwitchTile(
              ...
              (value) => setState(
                () =>
                    _currentOptions = _currentOptions.copyWith(showSize: value),
              ),
            ),
            _buildSwitchTile(
