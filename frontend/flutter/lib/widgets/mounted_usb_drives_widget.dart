...
class MountedUsbDrivesWidget extends StatefulWidget {
  ...
  const MountedUsbDrivesWidget({super.key, required this.onNavigate});
...
class _MountedUsbDrivesWidgetState extends State<MountedUsbDrivesWidget> {
  ...
  Widget _buildUsbDrivesList(BuildContext context) {
    ...
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children:
          _usbDrives.map((drive) {
            final driveLabel =
                drive.label.isNotEmpty
                    ? drive.label
                            ...
                            children: [
                              Flexible(
                                child: _buildActionButton(
                                  ...
                                  label: 'Unmount',
                                  onPressed:
                                      () => _unmountDrive(buttonContext, drive),
                              ...
                              Flexible(
                                child: _buildActionButton(
                                  ...
                                  label: 'Eject',
                                  onPressed:
                                      () => _ejectDrive(buttonContext, drive),
                                  isDarkMode: isDarkMode,
                                ),
                              ),
                            ],
        ...
        await showDialog<bool>(
          ...
          builder:
              (BuildContext dialogContext) => AlertDialog(
                ...
                content: Text(
                  'Are you sure you want to unmount ${drive.label.isNotEmpty ? drive.label : drive.deviceName}?',
                ),
                actions: [
                  TextButton(
    ...
    try {
      ...
      if (success) {
        ...
        NotificationService.showNotification(
          messenger,
          message:
              '${drive.label.isNotEmpty ? drive.label : drive.deviceName} unmounted successfully',
    ...
    try {
      ...
      if (success) {
        ...
        NotificationService.showNotification(
          messenger,
          message:
              '${drive.label.isNotEmpty ? drive.label : drive.deviceName} ejected successfully',
          type: NotificationType.success,
        );
